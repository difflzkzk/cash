	...
	<form method="post" action="${pageContext.request.contextPath}/admin/updateCashbook?cashbookId=${cashOne.cashbookId }&currentYear=${currentYear}&currentMonth=${currentMonth}&currentDay=${currentDay}">
		<table class="table table-hover">
			...
			<tr>
				...
				<td>
					<input type="text" pattern="[0-9]+" id="cashbookPrice" name="cashbookPrice" value="${cashOne.cashbookPrice }">
				</td>
			</tr>
			<tr>
				<td>cashbook_content</td>
				<td>
					<input type="text" id="cashbookContent" name="cashbookContent" value="${cashOne.cashbookContent }">
				</td>
			</tr>
		</table>
		<button class="btn btn-outline-success" id="submitBtn" type="submit" >수입/지출 수정</button>
	</form>
</div>
</body>
</html>